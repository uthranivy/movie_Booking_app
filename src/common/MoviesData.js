...
let moviesDataImg = [
    ...
    },
    {
        ...
        duration: 152,
        poster_url: "https://m.media-amazon.com/images/M/MV5BMTMxNTMwODM0NF5BMl5BanBnXkFtZTcwODAyMTk2Mw@@._V1_FMjpg_UY720_.jpg",
            ...
            <div> 
                ...
                <Box
                    sx={{ 
                        color: 'white', 
                        display: 'flex',
                        flexWrap: 'nowrap', overflowX: 'scroll', overflowY:'hidden',
                        alignContent: 'flex-start',
                        listStyle: 'none', 
                    }} > 
                    {moviesDataImg.map((item) => ( 
                        
                        <div className="postImage" key={item.id} >
                        <img className="thumbnail" src={`${item.poster_url}`} alt={item.title}  height={250}  />
                        {/* <span className="commercial">{item.title}</span> */}
                        <ImageListItemBar
                                title= {item.title}
                            />
                      </div>   
