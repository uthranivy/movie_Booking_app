...
import { Grid, InputLabel, Card, CardActions, CardContent, FormGroup } from '@material-ui/core';
import "./Form.css"
import {FormLabel,FormControlLabel, Checkbox, FormControl, MenuItem, Select} from '@material-ui/core'; 
          ...
          <div className="Section-Two">
              <Grid container>
                  <Grid item xs={9} style={{ background: 'blue' }}>
                      <form autoComplete="off">
                          <FormControl  >
                              ...
                              >
                                  {this.state.artists.map((option, key) => (
                                      <MenuItem value={option.profile_url} key={option.id}>
                                          <img src={option.profile_url} alt={option.role_type} />{" "}
                                      </MenuItem>
                                  ))}
                              </Select>
                          </FormControl>
                  ...
                  <Grid item xs={3} style={{ background: 'white' }} >
                      ...
                      <Box sx={{ padding: '10', }} className="Grid-Two">
                          <Card sx={{minWidth: '240', maxWidth: '240'  }} >
                              <CardContent>
                                  <FormGroup>
                                      <FormControl component="fieldset" variant="standard" className="Form-set" >
                                          <FormLabel component="legend" className="Form-set"> FIND MOVIES BY:</FormLabel>
                                      ...
                                      <FormControl component="fieldset" variant="standard">
                                          ...
                                          <Select>
                                              {genres.map((item) => (
                                                        <MenuItem key={item.id}> <FormControlLabel
                                                        control={
                                      ...
                                      <InputLabel>Artists</InputLabel>
                                          ...
                                          {this.state.artists.map((list) => (
                                                        <MenuItem key={list.id}> <FormControlLabel
                                                        control={
                                                          <Checkbox name={list.first_name} />
                                                        }
